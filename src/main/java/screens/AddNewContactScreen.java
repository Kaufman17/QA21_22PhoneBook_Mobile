...
public class AddNewContactScreen extends BaseScreen{
        ...
        public screens.AddNewContactScreen fillContactForm(Contact contact){
        ...
        public screens.AddNewContactScreen submitContactFormNegative(){
            createBtn.click();
            return this;
        }
        public screens.AddNewContactScreen isErrorContainsText(String text){
            checkAlertText(text);
            return this;
        }
